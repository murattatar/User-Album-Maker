...
bsli_x = unicode(str(size * .85))
bsli_y = unicode(str(size / 2.4))
...
.tile:hover ~ .tile {
  ...
  -webkit-transform: scale(.93) translate3d(""" + bsli_x + u"""px, """ + bsli_y + u"""px, 0);
          transform: scale(.93) translate3d(""" + bsli_x + u"""px, """ + bsli_y + u"""px, 0);
